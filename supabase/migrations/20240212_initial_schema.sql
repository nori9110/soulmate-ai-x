...
('フリー', '特定のテーマにとらわれず、自由に話し合いたい内容について対話します。
例：
- 今日あった出来事について
- 気になっていることの相談
- 雑談や話し相手として
...
('フリー', '特定のアプローチにとらわれず、状況に応じて柔軟に対話を進めます。
特徴：
- 状況に応じた最適なアプローチの選択
- 自然な対話の流れを重視
- 複数のアプローチの組み合わせ
- 柔軟な対応とスタイルの変更
例：
あなた：「最近、色々なことが重なって悩んでいます...」
AI：「そうですね、一つずつ整理しながら、あなたのペースで話していきましょう。まずは、今一番気になっていることから教えていただけますか？」'),
